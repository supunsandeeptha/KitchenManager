...
public class AvailabilityFilterRecyclerViewAdapter extends RecyclerView.Adapter<AvailabilityFilterRecyclerViewAdapter.ViewHolder> {
    ...
    //constructor
    public AvailabilityFilterRecyclerViewAdapter(List<KitchenItem> filterModelList, Context ctx) {
    ...
    @NonNull
    @Override
    public AvailabilityFilterRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        //inflating the layout
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kitchen, parent, false);

        //initialization a new view holder
    ...
    @Override
    public void onBindViewHolder(@NonNull AvailabilityFilterRecyclerViewAdapter.ViewHolder holder, int position) {
        KitchenItem filterM = filterList.get(position);
        //setting the values to the inflated layout's elements
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked) {
                      ...
                      /*  Toast.makeText(ProductFilterRecyclerViewAdapter.this.context,
                        ...
                        Toast.makeText(AvailabilityFilterRecyclerViewAdapter.this.context,"Length is " + finalsize,Toast.LENGTH_SHORT).show();*/
